...
{{--                                    <li><a href="{{ route('login') }}">Login</a></li>--}}
                            ...
                            <li class="dropdown"><a href="/public/extensions#">Blog<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="/public/extensions/blog.html">Blog List</a></li>
                                    <li><a href="/public/extensions/blog-single.html">Blog Single</a></li>
                                </ul>
                            </li>
                            <li><a href="/public/extensions/404.html">404</a></li>
                            <li><a href="/public/extensions/contact-us.html">Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-3">
